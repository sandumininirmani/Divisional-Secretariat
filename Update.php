<?php 
    ...
    $sql="SELECT * FROM `details` WHERE `lno`='$lno'";
    ...
    if(isset($_POST['submit'])){
        ...
        if($_FILES["uploadfile"]["name"]=="") {
            ...
            $filename_x=$_FILES["uploadfile"]["name"];
            $tempname=$_FILES["uploadfile"]["tmp_name"];

            $filename="pic_".date('YmdHis')."-".rand(10,999999)."_".$filename_x;
        ...
        $sql="UPDATE `details` SET `lno`='$lno',`doi`='$doi',`leno`='$leno',`esno`='$esno',`noc`='$noc',`hli`='$hli',`vod`='$vod',`mea`='$mea',`pno`='$pno',`lotno`='$lotno',`siz`='$siz',`suc`='$suc',`allo`='$allo',`ono`='$ono',`doio`='$doio',`odet`='$odet' WHERE `lno`='$lno'";
...
<main>
      <section class="glass">
        ...
        <div class="games">
            <div class="status">
                <center>        
                <h1 style="color:#426696;font-weight: 600;font-size: 3rem;opacity: 0.8;">Update Details</h1>  
                </center>
            </div>
          ...
          <form class="form-signin" action="" method="post" name="form" enctype="multipart/form-data">
            ...
            <div class="row">
              ...
              <input class="full-width " type="text" name="lno" value="<?php echo $lno; ?>" placeholder="" readonly="readonly"/>
            </div> <br>

            <div class="row">
             <label for="doi" class="text-left" >නිකුත් කල දිනය</label>
             <input class="full-width " type="date" name="doi" value="<?php echo $doi; ?>" placeholder="" />
            </div> <br>

            <div class="row">
             <label for="leno" class="text-left" >ලෙජර අංකය</label>
             <input class="full-width " type="text" name="leno" value="<?php echo $leno; ?>" placeholder="" />
            </div> <br>

            <div class="row">
             <label for="esno" class="text-left" >e-slims අංකය</label>
             <input class="full-width " type="text" name="esno" value="<?php echo $esno; ?>" placeholder="" />
            </div> <br>

            <div class="row">
             <label for="noc" class="text-left" >කට්ටිකරුගේ නම</label>
             <input class="full-width " type="text" name="noc" value="<?php echo $noc; ?>" placeholder="" />
            </div> <br>
             
            <div class="row">
             <label for="hli" class="text-left" >බලපත්‍රය නිකුත්කල ආකරය</label>
             <input class="full-width " type="text" name="hli" value="<?php echo $hli; ?>" placeholder="" />
            </div> <br>

            <div class="row">
             <label for="vod"  class="text-left" >ග්‍රාම නිලධාරී වසම</label>
             <input class="full-width " type="text" name="vod" value="<?php echo $vod; ?>" placeholder="" />
            </div> <br>

            <div class="row">
             <label for="mea"  class="text-left" >මැනුම් කර ඇත/නැත</label>
             <input class="full-width " type="text" name="mea" value="<?php echo $mea; ?>" placeholder="" />
            </div> <br>

            <div class="row">
             <label for="pno"  class="text-left" >පිඹුරු අංකය</label>
             <input class="full-width " type="text" name="pno" value="<?php echo $pno; ?>" placeholder="" />
            </div> <br>

            <div class="row">
             <label for="lotno"  class="text-left" >කැබලි අංකය</label>
             <input class="full-width " type="text" name="lotno" value="<?php echo $lotno; ?>" placeholder="" />
            </div> <br>

            <div class="row">
             <label for="siz"  class="text-left" >ප්‍රමාණය</label>
             <input class="full-width " type="text" name="siz" value="<?php echo $siz; ?>" placeholder="" />
            </div> <br>

            <div class="row">
             <label for="suc"  class="text-left" >පසු උරුමකරුගේ නම/ උරුමකරුවන්ගේ නම්</label>
             <input class="full-width " type="text" name="suc" value="<?php echo $suc; ?>" placeholder="" />
            </div> <br>

            <div class="row">
             <label for="allo"  class="text-left" >දීමනා පත්‍රයක් නිකුත් කර ඇත/නැත</label>
             <input class="full-width " type="text" name="allo" value="<?php echo $allo; ?>" placeholder="" />
            </div> <br>

            <div class="row">
             <label for="ono"  class="text-left" >දීමනා පත්‍ර අංකය</label>
             <input class="full-width " type="text" name="ono" value="<?php echo $ono; ?>" placeholder="" />
            </div> <br>

            <div class="row">
             <label for="doio"  class="text-left" >දීමනා පත්‍රය නිකුත් කල දිනය</label>
             <input class="full-width " type="date" name="doio" value="<?php echo $doio; ?>" placeholder="" />
            </div> <br>

            <div class="row">
             <label for="odet"  class="text-left" >වෙනත් විස්තර </label>
              <input class="full-width " type="text" name="odet" value="<?php echo $odet; ?>" placeholder="" />
            </div>
            
              

                <!-- <input type="submit" name="submit" value="Update Now" class="btn-signin bbt refreshicon"> -->
              ...
              <div class="row">
                ...
                data-ckav-smd="button-medium" value="Update Now" />
              </div>

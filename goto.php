        ...
        <div class="home-area intro-section flex-cc" data-ckav-smd="padding-b-0 flex-cc">
            ...
            <div class="container zindex-1 intro-element">
                ...
                <div class="intro-text typo-light align-center">
                    ...
                    <br><br>
                    <h2 class="heading xlarge bold-900 text-upper" data-ckav-smd="large">Welcome!</h2>
                    <p class="heading large  width-60 bold-900 margin-auto" data-ckav-smd="width-100 mini">
                       - Plot Details -
                    </p>
                    <a href="Register.php" class=" button button-xlarge color-button-default color-hov-button-white solid radius-10" data-ckav-smd="button-medium">Add New</a> 
                    &nbsp;&nbsp;&nbsp;
                    <a href="Display.php" class=" button button-xlarge color-button-default color-hov-button-white solid radius-10" data-ckav-smd="button-medium">View All</a>
                </div>
            ...
            <div class="bg-holder zindex-0">
                ...
                <!-- OVERLAY -->
                <b data-bgholder="overlay" class="full-wh zindex-2" data-linear-gradient="rgba(0,0,0, 0)|rgba(0,0,0, 0.8)"></b>
                
                <!-- ANIMATION -->
                <div class="full-wh zindex-1">
                    <div class="bg-anim bg-cover bg-cc" data-bg-image="images/anim-bg.jpg"></div>
                </div>
                        ...
                        <div class="row align-items-center gt60">
                            ...
                            <div class="col-lg-6">
                                <div class="section-heading-wrapper" data-ckav-smd="align-center">
                                    <h2 class="heading-section text-upper default bold-900 animated" data-anim-in="fadeInUp" data-ckav-smd="medium">About Me</h2>
                                    <p class="heading-section-sub small margin-b-0 animated" data-anim-in="fadeInUp|0.1" data-ckav-smd="mini">
                                    I am Sandumini Nirmani
                                    </p>
                                </div>
...
<!-- ======= END : ABOUT SECTION =======  -->
                    ...
                    <div class="container">
                        ...
                        <div >
                            ...
                            <div class="col align-center animated" data-anim-in="fadeInUp|0.3" data-ckav-smd="margin-b-30">
                                <a href="https://www.facebook.com/welivitiya/" target="_blank" class="button button-icon-xlarge color-button-white border-op-light-2 radius-10"><i class="fab fa-facebook-f"></i></a>
                            
                                &nbsp;&nbsp;&nbsp;&nbsp;
                           
                                <a href="http://www.welivitiya.ds.gov.lk/index.php/en/" target="_blank" class="button button-icon-xlarge color-button-white border-op-light-2 radius-10"><i class="fab fa-dribbble"></i></a>
                            </div>
        ...
        *************************************************************
        ...
        <div class="footer-area intro-element">
            <div class="container">
                <p class="c-text navigation">                
                    <a class="c-text  section-post" href="#about" onMouseOver="this.style.color='Red'" onMouseOut="this.style.color='white'" >Develop by Sandumini Nirmani</a> © <script>document.write(new Date().getFullYear());</script>
                </p>
            </div>
        </div>
        <!-- ************** END : FOOTER **************  -->
        ...
        *************************************************************
        ...
        <div id="popup-content" class="white-popup-block popup-content animate fadeInDown mfp-hide radius-6">
            <div class="pop-header padding-b-0" data-ckav-sm="padding-30 padding-b-0">
                ...
                <h2 class="heading-section default bold-900 text-upper mr-0" data-ckav-sm="small">LOGIN</h2>
            </div>
                    ...
                    <form action="crud/index.php" method="post">
                        <div class="field-wrp">
                            ...
                            <div class="row gt10">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <input class="form-control radius-6" data-label="Name" required="" data-msg="Please enter name." type="text" name="name" placeholder="Enter Username">
                                    </div>
                                </div>
<!-- ******************************************************************************************************************************  -->
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <input class="form-control radius-6" data-label="Password" required="" data-msg="Please enter password." type="password" name="password" placeholder="Enter Password">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <button type="submit" class="button radius-6 solid color-button-default width-100 margin-0"><i class="fa fa-envelope-o"></i> Sign in</button>
                    </form>
                </div>
            </div>
        </div>
